...
public class ThreeWheelTrackingLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double FORWARD_OFFSET = 5.312; // in; offset of the lateral wheel
    ...
    public static double LATERAL_DISTANCE = 13.033 * LATERAL_DISTANCE_MULT; // in; distance between the L/R wheels
    ...
    public ThreeWheelTrackingLocalizer(HardwareMap hardwareMap) {
        super(Arrays.asList(
                new Pose2d(-0.937, 6.47*LATERAL_DISTANCE_MULT, 0), // left
                new Pose2d(1, -6.563*LATERAL_DISTANCE_MULT, 0), // right
                new Pose2d(-FORWARD_OFFSET, -0.375, Math.toRadians(90)) // front
        ));
