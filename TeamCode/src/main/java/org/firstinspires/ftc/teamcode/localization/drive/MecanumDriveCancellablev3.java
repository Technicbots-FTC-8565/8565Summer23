 ...
 */
@Config
public class MecanumDriveCancellablev3 extends MecanumDrive {
	/*
	public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(25, 0.003, 2);
	public static PIDCoefficients HEADING_PID = new PIDCoefficients(10, 0, 0.5);
	*/
	public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients( 14, 0.01, 0.8);
	public static PIDCoefficients HEADING_PID = new PIDCoefficients(12, 0.01, 2);
	public static PIDCoefficients LOCK_PID = new PIDCoefficients(15, 0, 2.5);
	...
	private PIDFController leftFrontPIDF = new PIDFController(LOCK_PID);
	private PIDFController leftBackPIDF = new PIDFController(LOCK_PID);
	private PIDFController rightFrontPIDF = new PIDFController(LOCK_PID);
	private PIDFController rightBackPIDF = new PIDFController(LOCK_PID);
	private Relocalizer relocalizer;
	public Pose2d poseEstimate = new Pose2d();

	public MecanumDriveCancellablev3(HardwareMap hardwareMap) {
		super(kV, kA, kStatic, TRACK_WIDTH, TRACK_WIDTH, LATERAL_MULTIPLIER);

		follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
				new Pose2d(0.5, 0.5, Math.toRadians(1.0)), 1.0); // TODO: see if increasing the admissible heading error works for its intended purposes or not
		...
		//TODO: Reverse any motors necessary
		...
		this.relocalizer = new Relocalizer(hardwareMap, new Pose2d());
...
//		return imu.getAngularOrientation().firstAngle; // TODO: Note
		 return 0;
	}
	...
	public boolean isDone() { return !isBusy(); }
}